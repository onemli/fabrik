...
urlpatterns = [
    ...
    path('explorer/class/<str:class_name>/', views.get_explorer_class_detail, name='explorer_class_detail'),
    path('explorer/relationships/<str:class_name>/', views.get_explorer_relationships, name='explorer_relationships'),
    path('explorer/class/<str:class_name>/insights/', views.get_class_insights, name='explorer_class_insights'),
    path('explorer/ancestors/<str:class_name>/', views.get_class_ancestors, name='explorer_class_ancestors'),
    ...
    path('classes/<str:class_name>/hierarchy/', views.get_class_hierarchy, name='get_class_hierarchy'),
    path('classes/<str:class_name>/related/', views.get_related_classes, name='get_related_classes'),
    path('classes/<str:parent_class>/children/search/', views.search_child_classes, name='search_child_classes'),
