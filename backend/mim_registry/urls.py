...
urlpatterns = [
    ...
    path(
        'devnet/runs/<uuid:run_id>/cancel/',
        views.devnet_run_cancel_view,
        name='mim-registry-devnet-run-cancel',
    ),
    path(
        'devnet/runs/<uuid:run_id>/resume/',
        views.devnet_run_resume_view,
        name='mim-registry-devnet-run-resume',
    ),
]
