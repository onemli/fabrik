...
class AWXConnectionAdmin(admin.ModelAdmin):
    list_display = ['name', 'url', 'auth_type', 'awx_version', 'last_test_status', 'is_public', 'created_at']
...
class AutomationExecutionAdmin(admin.ModelAdmin):
    list_display = ['awx_job_id', 'status', 'automation_request', 'progress_percentage', 'started_at', 'finished_at']
